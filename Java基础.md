...
`例：int[][] array =  new int[][]{{11,22},{33,44}}`

`简化格式：数据类型[][] 数组名 = {{元素1，元素2}，{元素1，元素2}}`

`例：int[][] array =  {{11,22},{33,44}}`

`例：int array[][] =  {{11,22},{33,44}}` 这种也可以，但根据阿里巴巴编码规范，一般用第一种。

### **动态初始化：**

`完整格式：数据类型[][] 数组名 = new 数据类型[m][n]`

`例：int[][] array =  new int[2][3] `
